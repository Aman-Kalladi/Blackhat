...
class Detector:
    ...
    def get_key_press(self):
        for i in range(0, 0xff):
            ...
            if state & 0x0001:
                if i == 0x1:  # Left mouse button
                    self.mouse_clicks += 1
                    return time.time()
                elif i > 32 and i < 127:  # Printable ASCII range
                    self.keystrokes += 1
                    return None
    ...
    def detect(self):
        ...
        while not detection_complete:
            ...
            previous_timestamp = keypress_time if keypress_time is not None else previous_timestamp
